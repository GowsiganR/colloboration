myApp.controller("BlogController", function($scope,$location,$rootScope,$http,$route) {
	...
	$scope.addBlog=function() {
	      ...
	      $http.post('http://localhost:8090/Middleware/addBlog',$scope.blog)
	...
	{
		$http.post('http://localhost:8090/Middleware/updateBlog',$scope.blog)
		.then(function(response) {
	...
	$scope.incrementLikes=function(blogId) {
		 $http.get('http://localhost:8090/Middleware/incrementLikes/'+blogId)
		 .then(function(response) {
	...
	$scope.incrementDislikes=function(blogId) {
		 $http.get('http://localhost:8090/Middleware/incrementDislikes/'+blogId)
		 .then(function(response) {
	...
	$scope.deleteBlog=function(blogId) {
		 $http.get('http://localhost:8090/Middleware/deleteBlog/'+blogId)
		 .then(function(response) {
	...
	$scope.approveBlog=function(blogId) {
		 $http.get('http://localhost:8090/Middleware/approveBlog/'+blogId)
		 .then(function(response) {
	...
	$scope.rejectBlog=function(blogId) {
		 $http.get('http://localhost:8090/Middleware/rejectBlog/'+blogId)
		 .then(function(response) {
	...
	function listBlogs() 
	{
		...
		$http.get('http://localhost:8090/Middleware/getBlogs')
		.then(function(response) {
	...
	function getBlog()
	{
		$http.get('http://localhost:8090/Middleware/getBlog/'+$rootScope.blogId)
		.then(function(response) {
